...
async function main() {
  ...
  const p1 = await prisma.product.create({
    data: {
      ...
      vendorId: vendor.id,
      coverImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDFcPgLqDsW7aRmEjI276UgO03VbS9KGyTi3RPJ_f4Q27HuZEXX-uY1ann2CQukzGzWsX447fRLb9PKGECF0GiXPlpyTfjimylKGQWmAnXD9OeE5Umz9PwAAKoWtO1mYuX8WviRRvT_ARGQ2GssDwzHSXQTFX3DFRTgLdoM90mSR1Ob43jmOPwcn0gB0I5RctSBfcW3pKR8lwjb659_qwMyvtLqGAc8QZVkHsuzqI6PUhS15oxPG9pdQRR4MfkdMwvFmYPt5SPK0CoZ',
    }
  });
  ...
  const p2 = await prisma.product.create({
    data: {
      ...
      vendorId: vendor.id,
      coverImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBDI-NRmZPNvKCcMM1DCSK8uz56DBqPXY6DFn1mZB-Y7C7ekx2Arh-PbdIW1lG4mOjK0EwxSMArrQh2B69BBOGhRKFrNrTwPN_RuYFXPkmZyESbHaFmTMnptgC6cR106fAZ8knHUZZp5bnebr-EsN1VSWXTL4qQOu9ooVCmZNBRn4ezp0E7SCJlMAgtyI2dgZ2o8kwgZJCQwSNtqvKqu9KrYl_71YeJ3mslQNHv0FdB-UrzTqZ8BULrmox_R0XX0MozZsAehUaF073P',
    }
  });
